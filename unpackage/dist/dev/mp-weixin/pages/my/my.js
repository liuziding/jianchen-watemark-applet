...
/* harmony import */ var _my_vue_vue_type_template_id_0be17cc6_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./my.vue?vue&type=template&id=0be17cc6&scoped=true& */ 55);
...
/* harmony import */ var _my_vue_vue_type_style_index_0_id_0be17cc6_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./my.vue?vue&type=style&index=0&id=0be17cc6&lang=scss&scoped=true& */ 59);
...
var _default = {
  ...
  methods: {
      ...
      uni.chooseImage({
        success: function success(res) {
          ...
          uni.getImageInfo({
            src: tempFilePath,
            success: function success(info) {
              _this2.imgWidth = info.width;
              _this2.imgHeight = info.height;
              // 设置canvas画布宽高
              _this2.canvas.width = _this2.imgWidth;
              _this2.canvas.height = _this2.imgHeight;
              // 绘制图片
              _this2.ctx.drawImage(tempFilePath, 0, 0, _this2.imgWidth, _this2.imgHeight);
            }
          });
        }
      });
    ...
    isRectSelected: function isRectSelected(x, y) {
      // 判断是否选中矩形框
      var left = this.rectX - this.rectWidth / 2;
      var right = this.rectX + this.rectWidth / 2;
      var top = this.rectY - this.rectHeight / 2;
      var bottom = this.rectY + this.rectHeight / 2;
    ...
    moveRect: function moveRect(dx, dy) {
      // 移动矩形框
      var newX = this.rectX + dx;
      var newY = this.rectY + dy;
    ...
    confirmPosition: function confirmPosition() {
      // 确定位置并输出结果
      if (this.rectMoved) {
        var left = this.rectX - this.rectWidth / 2;
        var top = this.rectY - this.rectHeight / 2;
